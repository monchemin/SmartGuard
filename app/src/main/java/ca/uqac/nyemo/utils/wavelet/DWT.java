...
public class DWT {
	 ...
	 * @param wavelet
	 *            Haar, Daubechies, etc. (see ca.uqac.nyemo.utils.wavelet.OrthogonalFilters.java)
	 * @param order
	 ...
	 * @param L
	 *            coarsest scale
	 * @return Forward ca.uqac.nyemo.utils.wavelet.DWT
	 * @throws Exception
	 *             Invalid wavelet parameters
	 */
	 ...
	 * @param L
	 *            coarsest scale
	 * @return reconstructed signal by inverse ca.uqac.nyemo.utils.wavelet.DWT
	 * @throws Exception
	 */
	...
	/**
	 * Multi-resolution analysis See: Mallet, A ca.uqac.nyemo.utils.wavelet.Wavelet Tour of ca.uqac.nyemo.utils.wavelet.SignalProcess
	...
	/**
	 * ca.uqac.nyemo.utils.wavelet.Wavelet/param/scale/size sanity check
	 * 
	 * @param wavelet
	 * @param order
	 * @param L
	 ...
	 * using each of the orthogonal filters provided in ca.uqac.nyemo.utils.wavelet.OrthogonalFilters.java
